...
const ContentThumbnail = ({
  ...
  const thumbnailGenerator = () => (
    <div className="relative min-w-[181px] min-h-[266.5px] md:min-w-[228px] lg:min-w-[248px] lg:min-h-[362px]  md:min-h-[342px]  cursor-pointer opacity-95 hover:opacity-100 hover:scale-110 transition-all duration-150 ease-in-out hover:saturate-200 flex items-center rounded-md  drop-shadow-md hover:drop-shadow-2xl  -z-9 ">
