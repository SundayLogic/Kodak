...
const ContentSlider = ({ contentResults, sliderName }: ContentSliderProps) => {
  return (
    <section className="mt-2 pb-12 px-3 pt-3 h-[27vh] md:h-[34vh] lg:h-[40vh] flex flex-col space-y-3 -z-20 group">
      <TextAtom text={sliderName} type={"SECTION"} />
      <div className="flex pl-5 items-center overflow-x-scroll lg:space-x-5 md:space-x-4 space-x-3 scrollbar-hide h-[29vh] md:h-[30vh] lg:h-[39vh] z-1 ">
